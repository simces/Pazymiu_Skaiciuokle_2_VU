...
int main() {
    ...
    char tn;
    cout << "Ar norite, jog duomenis butu sugeneruoti automatiskai ir iskarto nuskaityti? (taip - t, ne - n): ";
    cin >> tn;
    cin.ignore();
    checkInputChar(tn);
    char gen;
    cout << "Ar norite sugeneruoti nauja faila? (taip - t, ne - n): ";
    cin >> gen;
    if (gen == 't') {
        generationNumber();
    }
        ...
        if (tn == 't') {
            ...
            if (tn == 't') {
                ...
                while (true) {
                    ...
                    cout << "Ar norite prideti dar viena studenta? (taip - t, ne - n): ";
                    cin >> tn;
                    cin.ignore();
                    checkInputChar(tn);
                    if (tn == 'n') {
